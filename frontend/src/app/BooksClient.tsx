    ...
    <div className="flex bg-[#f8f7f4] min-h-screen font-sans selection:bg-orange-200">
      ...
      <div className="flex-1 ml-0 md:ml-64 pt-16 md:pt-0 flex flex-col min-h-screen">
        ...
        <header className="sticky top-16 md:top-0 z-30 bg-[#f8f7f4]/80 backdrop-blur-md px-4 py-4 md:px-10 md:py-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
          ...
          <div className="flex items-center gap-6 md:gap-8 text-sm font-bold text-gray-400 overflow-x-auto w-full md:w-auto no-scrollbar">
          ...
          <div className="flex items-center w-full md:w-auto">
            <div className="relative w-full">
              ...
              <input 
                ...
                className="w-full md:w-72 bg-white rounded-full py-2.5 pl-12 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-500/50 shadow-sm transition-all text-black placeholder-gray-400"
              />
            </div>
          </div>
        </header>

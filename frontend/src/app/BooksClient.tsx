      ...
      <div className="flex-1 ml-0 md:ml-64 pt-16 md:pt-0 flex flex-col min-h-screen w-full max-w-full">
        ...
        <header className="sticky top-16 md:top-0 z-30 bg-[#1F1D20]/90 backdrop-blur-md px-4 py-4 md:px-10 md:py-6 flex flex-col md:flex-row justify-between items-start md:items-center border-b border-[#4D4845]/30 gap-4 md:gap-0">
          ...
          <div className="flex items-center gap-6 md:gap-8 text-base md:text-sm font-bold text-[#D7C9B2] overflow-x-auto w-full md:w-auto no-scrollbar">
             <a href="#" className="text-[#F5ECDC] border-b-2 border-[#F97316] pb-1 whitespace-nowrap">New Release</a>
          ...
          <div className="flex flex-col md:flex-row items-center w-full md:w-auto gap-3">
            <div className="relative w-full">
              ...
              <input 
                ...
                className="w-full md:w-72 bg-[#2A272A] border border-[#4D4845]/60 rounded-full py-3.5 md:py-2.5 pl-12 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#F97316]/50 shadow-inner transition-all text-[#F5ECDC] placeholder-[#7B7369]"
              />
            </div>
            ...
            <select
              ...
              className="w-full md:w-auto bg-[#2A272A] border border-[#4D4845]/60 rounded-full py-3.5 md:py-2.5 px-5 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-[#F97316]/50 shadow-inner transition-all text-[#F5ECDC] cursor-pointer appearance-none pr-10"
